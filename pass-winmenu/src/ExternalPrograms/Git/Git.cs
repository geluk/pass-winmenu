...
namespace PassWinmenu.ExternalPrograms
{
	...
	internal class Git : IDisposable, ISyncService
	{
		...
		private void CommitFile(string filePath)
		{
			...
			string relPath = new Uri(repo.Info.WorkingDirectory).MakeRelativeUri(new Uri(filePath)).OriginalString;
			var message = $"{GetVerbFromGitFileStatus(status)} password store file {relPath}\n\n" + 
